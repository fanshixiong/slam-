...
get_filename_component(_filename "/home/frans/code/learn_slam/slam-/lio/localization_in_auto_driving-5.0/src/lidar_localization/srv/saveMap.srv" NAME_WE)
add_custom_target(_lidar_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lidar_localization" "/home/frans/code/learn_slam/slam-/lio/localization_in_auto_driving-5.0/src/lidar_localization/srv/saveMap.srv" ""
)
...
_generate_srv_cpp(lidar_localization
  "/home/frans/code/learn_slam/slam-/lio/localization_in_auto_driving-5.0/src/lidar_localization/srv/saveMap.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lidar_localization)
  install(CODE "execute_process(COMMAND \"/home/frans/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lidar_localization\")")
  # install generated code
  install(
